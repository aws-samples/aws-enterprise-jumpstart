...
aws cloudformation package --template-file templates/deployment.yaml --s3-bucket "$ARTIFACT_BUCKET_NAME" --s3-prefix "$ARTIFACTS_BUCKET_PREFIX" --output-template-file build/packaged-template.yaml
